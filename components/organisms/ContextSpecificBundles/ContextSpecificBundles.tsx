...
export const ContextSpecificBundles = () => {
  return (
    <section id="bundles" className="bg-core-blue py-16 text-white mb-20">
      <div className="container mx-auto">
        <MainHeading className="text-white">
          Context specific <span className="!font-light">bundles</span>
        </MainHeading>
        <p className="sm:text-lg md:text-xl mt-7 max-w-[880px] ">
          Introducing context specific bundles. We have tailored our APIs to
          meet specific and common use cases all bundled together to and ready
          to deploy in your project. Lorem ipsum dolor sit amet lacinia feugiat

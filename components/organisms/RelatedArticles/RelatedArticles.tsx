      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row gap-3 md:items-center md:justify-between ">
          <div className="flex items-center gap-3 md:gap-5">
            <h3 className="text-2xl md:text-[32px] text-core-blue font-bold">
              Related articles
            </h3>
            <ul className="flex gap-2">
              <li className="bg-core-lightBlue border-[2px] cursor-pointer rounded-full border-blue-600 text-white p-2">
                <FaStarOfLife size={14} />
              </li>
              <li className="bg-[#B71A5D] border-[2px] cursor-pointer rounded-full border-[#5C0E2F] text-white p-2">
                <FaFileAlt size={14} />
              </li>
              <li className=" border-[2px] cursor-pointer rounded-full border-[#662482] text-[#662482] p-2">
                <IoVideocam size={14} />
              </li>
              <li className=" border-[2px] cursor-pointer rounded-full border-[#657E1B] text-[#657E1B] p-2">
                <AiFillSound size={14} />
              </li>
            </ul>
          </div>
          <Button icon={<HiArrowNarrowRight />} iconPosition="right" size="md">
            View on Inform
          </Button>
        </div>
        <div className="mt-8">

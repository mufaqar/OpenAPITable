...
export const BroadbandScenarios = () => {
  return (
    <section id="section" className="py-20 bg-core-blue">
      <div className="container">
        <h2 className="text-2xl text-white md:text-[32px] font-bold">
          Wholesale broadband scenarios
        </h2>
        <p className="text-white mt-4 max-w-[800px]">
          Introducing what scenarios are. Lorem ipsum dolor sit amet lacinia
          feugiat tempor. Tellus curabitur odio dictumst scelerisque
          sollicitudin rhoncus sapien.Lorem ipsum dolor sit amet lacinia feugiat

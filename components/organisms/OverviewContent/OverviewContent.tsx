    ...
    <section className="bg-light-grey py-20">
      <div className="text-core-blue container mx-auto md:flex">
        ...
        <div className="flex-1 mt-4 md:mt-0">
          <p>
            One of the major barriers to network automation is a knowledge
            shortfall in CSPs, which leads to companywide knowledge gaps,
            prevalence of legacy systems & processes and lack of focus from
            senior management.
          </p>
          <Button
            size="md"
            ...
            iconPosition="right"
            className="!px-4 mt-4 py-2 bg-core-blue w-auto"
          >
